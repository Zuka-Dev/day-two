...
const mySecond= myTime.getSeconds();
const sayTime = document.createElement('p');
sayTime.appendChild(document.createTextNode(`The time is ${myHour}:${myMinutes}:${mySecond} WAT`));
document.querySelector('body').append(sayTime);